...
public final class ProtocolMaster implements Runnable, ProtocolEntity
{
    ...
    public static ProtocolMaster launch(String xml, Class<?>... protocolClasses)
    {
        ProtocolMaster protocolMaster = new ProtocolMaster(xml, protocolClasses);
        protocolMaster.run();
        return protocolMaster;
    }

    private ProtocolMaster(String xml, Class<?>[] protocolClasses)
    {
        this.xml = xml;
